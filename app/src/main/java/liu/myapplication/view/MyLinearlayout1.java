 ...
 *
 * 如果子view消费down，上级拦截了move事件，子view会调用cancel，然后move由上级消费，因为// Dispatch to touch targets.
 ...
 *             每次走这里
 *
 *  如果子view dispatchTouchEvent 直接返回true，可接受所有事件，用途？？
 */
public class MyLinearlayout1 extends LinearLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        Log.d("MyLinearlayout", "MyLinearlayout1-dispatchTouchEvent");
...
//                handle = true;
        ...
        Log.d("MyLinearlayout", "MyLinearlayout1-onInterceptTouchEvent");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()){
            case MotionEvent.ACTION_DOWN:
                Log.d("MyLinearlayout", "MyLinearlayout1 - onTouchEvent-ACTION_DOWN");
//                handle = true;
                break;
            case MotionEvent.ACTION_MOVE:
                Log.d("MyLinearlayout", "MyLinearlayout1 - onTouchEvent-ACTION_MOVE");
                break;
            case MotionEvent.ACTION_UP:
                Log.d("MyLinearlayout", "MyLinearlayout1 - onTouchEvent-ACTION_UP");
                break;
            case MotionEvent.ACTION_CANCEL:
                Log.d("MyLinearlayout", "MyLinearlayout1 - onTouchEvent-ACTION_CANCEL");
                break;
        }
